...
public class MonthCalendar extends GridPane implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		lista =new Label[] {unoLLabel,unoMLabel,unoXLabel,unoJLabel,unoVLabel,unoSLabel,unoDLabel,
				dosLLabel,dosMLabel,dosXLabel,dosJLabel,dosVLabel,dosSLabel,dosDLabel,
				tresLLabel,tresMLabel,tresXLabel,tresJLabel,tresVLabel,tresSLabel,tresDLabel,
				cuatroLLabel,cuatroMLabel,cuatroXLabel,cuatroJLabel,cuatroVLabel,cuatroSLabel,cuatroDLabel,
				cincoLLabel,cincoMLabel,cincoXLabel,cincoJLabel,cincoVLabel,cincoSLabel,cincoDLabel,
				seisLLabel,seisMLabel,seisXLabel,seisJLabel,seisVLabel,seisSLabel,seisDLabel};	
